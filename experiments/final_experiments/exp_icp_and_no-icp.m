...
kpts_types_icp = cshotpiggyicp{:,{'KP_Tipe'}};
kpts_rad_icp = cshotpiggyicp{:,{'KP_RAD'}};
desc_rad_icp = cshotpiggyicp{:,{'DESC_RAD'}};
inlier_rad_icp = cshotpiggyicp{:,{'INLIER_RAD'}};
dist_mm_icp = cshotpiggyicp{:,{'DISTmm'}};

kpts_rad_icp(396,1)
desc_rad_icp(396,1)
inlier_rad_icp(396,1)
...
kpts_types = cshotpiggy{:,{'KP_Tipe'}};
kpts_rad = cshotpiggy{:,{'KP_RAD'}};
desc_rad = cshotpiggy{:,{'DESC_RAD'}};
inlier_rad = cshotpiggy{:,{'INLIER_RAD'}};
dist_mm = cshotpiggy{:,{'DISTmm'}};
...
xlabel('samples');ylabel('distance(mm)');legend('icp');title('iss')

figure;
hold on;
histogram(iss_dist_icp,20)
histogram(iss_dist,20)
xlabel('distance(mm)');ylabel('samples');legend('icp');title('iss')
...
xlabel('samples');ylabel('distance(mm)');legend('icp');title('us')

figure;
hold on;
histogram(us_dist_icp,20)
histogram(us_dist,20)
xlabel('distance(mm)');ylabel('samples');legend('icp');
title('us')
...
title('susan')
xlabel('samples');ylabel('distance(mm)');legend('icp');
